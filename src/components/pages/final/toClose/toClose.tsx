  ...
  return (
    <section className={"text-center"}>
      <div className={"max-w-contentWrapper mx-auto"}>
        ...
        <NormalTextP
          text={
            "Вам даже не придётся читать стишок Деду Морозу! Просто выполните оставшиеся задания адвент-календаря до 23:59 26 декабря по Москве. Итоги подведём 27 декабря"
          }
          mt={16}
        />
